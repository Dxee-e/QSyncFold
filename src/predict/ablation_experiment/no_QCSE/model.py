...
class Model(nn.Module):
    ...
    def create_qc(self, N: int):
        ...
        wires_pos = list(
            range(num_wires_state_interaction, num_wires_state_interaction + 2)
        )
        ...
        def circuit(
            ...
            # return qml.probs(wires=wires_pos)
...
# out = net('LAASLACAL')
# distance  = torch.sqrt(torch.sum((out[1:] - out[:-1])**2, dim=-1))
# print(out, distance)

# replace QCSE by 体心立方晶格（Body-Centered Cubic, BCC）