...
class Model(nn.Module):
    ...
    def forward(self, protein_sequence: str, cutoff_interaction_number: int):
        """forward"""
        # preprocess
        ...
        for i in range(1, N):
            out = self.qc_layer(
                ...
                cutoff_interaction_number=cutoff_interaction_number,
            )
